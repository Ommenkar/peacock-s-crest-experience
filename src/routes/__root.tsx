...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Luxury resort near Kanher Dam, Satara. Elegant rooms, fine dining, weddings & events surrounded by nature." },
      { name: "author", content: "Peacock's Crest Resort" },
      { property: "og:title", content: "Peacock's Crest Resort, Satara" },
      { property: "og:description", content: "Luxury resort near Kanher Dam, Satara." },
