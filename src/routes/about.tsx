...
function About() {
  return (
    <PageShell>
      <PageHero eyebrow="Our Story" title="A quiet pursuit of beauty." image={gateway.url} />
      <section className="py-28">
        <div className="container-luxe grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <img src={lawn.url} alt="Resort grounds" className="w-full aspect-[3/4] object-cover" />
          </div>
            ...
            <div className="pt-6 border-t border-border grid grid-cols-3 gap-6">
              {[
                ...
                <div key={s.l}>
                  ...
                  <div className="mt-2 text-[10px] tracking-[0.28em] uppercase text-muted-foreground">{s.l}</div>
                </div>
              ))}
            </div>
          </div>
